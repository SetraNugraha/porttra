export const projects = [
  // Facebook Clone
  {
    ...
    youtube_url: "https://www.youtube.com/embed/TSGewQS7h1c?si=SCPpMj3sO58EUqxE",
  ...
  // Chattra
  {
    ...
    youtube_url: "https://www.youtube.com/embed/TcckpDhDSyg?si=NfvDzGrcJdMTHqqf",
    ...
    feature: ["Login", "Register", "Logout", "Update Profile User", "Add New Contact", "Send & Receiver Message Realtime with WebSocket"],
    tech: ["nestjs", "nextjs", "postgresql", "prisma", "typescript", "tailwind-css", "socketio"],
    issue: null,
    demoAccount: null,
  },
  ...
  // Pharmakey
  {
    ...
    youtube_url: "https://www.youtube.com/embed/Iahk1YMazHY?si=wWpPX7am-G-Fx1HW",
    image: "assets/project-image/pharmakey.png",
    description:
      "This project is a course available on BuildWithAngga.com. However, the course originally develops the project using Laravel. To enhance my programming skills, I decided to recreate the project using ExpressJS, ReactJS, Typescript, PostgreSQL & Prisma. This web app is a simple e-commerce platform for selling pharmaceuticals on a small scale, designed to serve a specific local area.",
    note: "Already Finish the project (watch demo video), it just needs to be deployed.",
    feature: [
      "Role Admin & Customer",
      "Private Route",
